    ...
    <div class="card-body">
      <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(160px,1fr));gap:20px">
        ...
        <div>
          ...
          <div class="font-bold" style="color:var(--green-600,#16a34a)">$ <?= number_format($pedido['sena'], 2, ',', '.') ?></div>
        </div>
        <div>
          ...
          <div class="font-bold" style="color:var(--red-600,#dc2626)">$ <?= number_format(max(0, $pedido['total'] - $pedido['sena']), 2, ',', '.') ?></div>
        </div>
        <?php endif; ?>
      </div>
      ...
      <table style="width:100%;border-collapse:collapse;font-size:.88rem">
        ...
        <tfoot>
          ...
          <tr>
            ...
            <td style="text-align:right;padding:6px 4px;font-weight:700;color:#16a34a">$ <?= number_format($pedido['sena'], 2, ',', '.') ?></td>
          </tr>
          <tr>
            <td colspan="3" style="text-align:right;padding:6px 4px;font-size:.82rem;color:var(--gray-500)">Saldo pendiente</td>
            <td style="text-align:right;padding:6px 4px;font-weight:700;color:#dc2626">$ <?= number_format(max(0, $pedido['total'] - $pedido['sena']), 2, ',', '.') ?></td>
          </tr>
          <?php endif; ?>
        </tfoot>
          </tr>
